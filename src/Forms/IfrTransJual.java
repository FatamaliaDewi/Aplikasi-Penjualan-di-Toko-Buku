...
public class IfrTransJual extends javax.swing.JInternalFrame {
    ...
    private void sum(){
        ...
        for (int i = 0; i < jumlah; i++) {
            ...
            double dataTotal = Double.valueOf(dataModel.getValueAt(i, 6).toString());
        ...
        if(tbDataTransaksi.getRowCount()<=0){
            ...
            String jml=tbDataTransaksi.getValueAt(i, 1).toString();
                ...
                if(btnSimpan.getText().equals("Simpan")){
                    sqlinsert = "insert into tbdetailpenjualan a, tbtransaksijual b set no_transjual='"+vno_transjual+"', "
                            +" kd_buku='"+vkd_buku+"', harga_beli='"+vharga_jual+"', harga_jual='"+vharga_jual+"' , jml_buku='"+jml+"' ";
                }else if(btnSimpan.getText().equals("Ubah")){
                    sqlinsert = "insert into tbdetailpenjualan set no_trans_jual='"+vno_transjual+"', "
                            +" kd_buku='"+vkd_buku+"', harga_jual='"+vharga_jual+"' , jml_buku='"+jml+"' ";
                }
                Statement stat = _Cnn.createStatement();
                ...
                JOptionPane.showMessageDialog(this,"Data berhasil disimpan",
                        "Informasi", JOptionPane.INFORMATION_MESSAGE);
                cleanTable(); clearInput(); disableInput(); btnTambah.setEnabled(true); txtCari.setText("");
